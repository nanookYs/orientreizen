...
#     Description: Easily Configure Google Analytics & Webmaster Tools for your wordpress websites & blogs. 
#     Author: Web Shouter
#     Version: 1.1         
...
if (!class_exists('WS_GOOGLE_WEBMASTER_TOOLS')) { 
	...
	class WS_GOOGLE_WEBMASTER_TOOLS {
		...
		function __construct() { 
			...
			add_action('wp_head', array(&$this, 'ws_add_js_scripts'), 5); // ER: Changed based on feedback
	...
	<h2 class="nav-tab-wrapper">
		...
		<div id="poststuff" class="ui-sortable meta-box-sortables">
			...
			<table class="form-table">
				...
				<tr valign="top">
                	<td style="width:100%;" colspan="2"><textarea rows="14" cols="90" style="margin: 0px; width: 100%; " id="ws_google_analytics_code" name="ws_google_analytics_code"><?php echo get_option('ws_google_analytics_code') ?></textarea></td>
                </tr>
		...
		<div id="poststuff" class="ui-sortable meta-box-sortables">
			...
			<table class="form-table">
				 ...
				 <tr valign="top">
					  <th scope="row" style="width: 180px;"><label class="checkbox" for="ws_google_webmaster_code"><?php _e('Google Webmaster Tools', 'webshouter'); ?>:</label></th>
					  <td>
				 ...
				 <tr valign="top">
					  <th scope="row" style="width: 180px;"><label class="checkbox" for="ws_bring_webmaster_code"><?php _e('Bing Webmaster Tools', 'webshouter'); ?>:</label></th>
					  <td>
				  ...
				  <tr valign="top">
					  <th scope="row" style="width: 180px;"><label class="checkbox" for="ws_alexa_varify_code"><?php _e('Alexa Verification ID', 'webshouter'); ?>:</label></th>
					  <td>
